...
namespace Game.Events
{
    public class KeyCatcher : MonoBehaviour
    {
        ...
        private void DisableOtherInput() => InputController.Instance.LockFullInput(int.MaxValue);
        private void EnableOtherInput() => InputController.Instance.UnlockFullInput(int.MaxValue);
        #endregion methods
    }
}